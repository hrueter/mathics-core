...
class Characters(Builtin):
    ...
    summary_text = "Characters summary still not available"
...
class CharacterRange(Builtin):
    ...
    summary_text = "CharacterRange summary still not available"
    messages = {
...
class LowerCaseQ(Test):
    ...
    summary_text = "LowerCaseQ summary still not available"
...
class ToLowerCase(Builtin):
    ...
    summary_text = "ToLowerCase summary still not available"
...
class ToUpperCase(Builtin):
    ...
    summary_text = "ToUpperCase summary still not available"
...
class UpperCaseQ(Test):
    ...
    summary_text = "UpperCaseQ summary still not available"
