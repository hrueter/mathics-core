...
class Dodecahedron(Builtin):
    ...
    summary_text = "Dodecahedron summary still not available"
    rules = {
...
class Icosahedron(Builtin):
    ...
    summary_text = "Icosahedron summary still not available"
    rules = {
...
class Octahedron(Builtin):
    ...
    summary_text = "Octahedron summary still not available"
    rules = {
...
class Tetrahedron(Builtin):
    ...
    summary_text = "Tetrahedron summary still not available"
    rules = {
