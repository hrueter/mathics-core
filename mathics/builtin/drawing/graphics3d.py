...
class Sphere(Builtin):
    ...
    summary_text = "Sphere summary still not available"
    rules = {
...
class Cone(Builtin):
    ...
    summary_text = "Cone summary still not available"
    messages = {
...
class Cylinder(Builtin):
    ...
    summary_text = "Cylinder summary still not available"
    messages = {
        "oddn": "The number of points must be even.",
        "nrr": "The radius must be a real number",
    }
...
class Tube(Builtin):
    ...
    summary_text = "Tube summary still not available"
    rules = {
