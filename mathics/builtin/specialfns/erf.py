...
class Erfc(_MPMathFunction):
    ...
    summary_text = "Erfc summary still not available"
    rules = {
...
class FresnelC(_MPMathFunction):
    ...
    summary_text = "FresnelC summary still not available"
    rules = {
...
class FresnelS(_MPMathFunction):
    ...
    summary_text = "FresnelS summary still not available"
    rules = {
...
class InverseErf(_MPMathFunction):
    ...
    summary_text = "InverseErf summary still not available"
    rules = {
...
class InverseErfc(_MPMathFunction):
    ...
    summary_text = "InverseErfc summary still not available"
    rules = {
