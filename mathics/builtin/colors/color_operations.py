...
class Blend(Builtin):
    ...
    summary_text = "Blend summary still not available"
    messages = {
        "arg": (
...
class ColorConvert(Builtin):
    ...
    summary_text = "ColorConvert summary still not available"
    messages = {
...
class Darker(Builtin):
    ...
    summary_text = "Darker summary still not available"
...
class Lighter(Builtin):
    ...
    summary_text = "Lighter summary still not available"
    rules = {
